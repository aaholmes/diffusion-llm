...
from src.generation.generate_conditional import load_conditional_model, generate
...
class TestLoadConditionalModel:
    ...
    def checkpoint_path(self, tmp_path):
        ...
        from src.core.model import DiffusionTransformer, TextEncoder, ModelConfig
...
class TestMainFunctionExecution:
    ...
    def test_main_full_execution(self, tmp_path, monkeypatch):
        ...
        from src.generation.generate_conditional import main
