...
from src.data.prep_coco_data import (
    download_file,
    load_coco_captions,
...
class TestDownloadCOCOImages:
    ...
    def test_download_skips_existing(self, tmp_path):
        ...
        from src.data.prep_coco_data import download_coco_images
...
class TestMainFunction:
    ...
    def test_argument_parsing(self):
        ...
        with patch.object(sys, 'argv', test_args):
            import argparse
            from src.data.prep_coco_data import main
...
class TestDownloadCocoAnnotations:
    ...
    def test_creates_annotations_dir(self, tmp_path):
        ...
        from src.data.prep_coco_data import download_coco_annotations
...
class TestIntegration:
    ...
    def test_full_pipeline_shapes(self, tmp_path):
        ...
        from src.data.prep_coco_data import extract_clip_features, tokenize_captions
        from tokenizers import Tokenizer
