...
from src.training.train_config_long import LongTrainConfig, print_config
from src.training.train_long import (
...
class TestPrepareFullDataset:
    ...
    def test_skip_if_already_prepared(self, tmp_path, monkeypatch):
        ...
        try:
            ...
            from src.training.train_long import prepare_full_dataset
    ...
    def test_prepare_calls_data_prep_when_forced(self, tmp_path, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setattr("src.training.train_long.prepare_data", mock_prepare_data)
...
class TestMainFunction:
    ...
    def test_find_latest_with_resume(self, tmp_path):
        ...
        from src.training.train_long import find_latest_checkpoint
...
class TestGenerateSamplesEOS:
    ...
    def test_generate_samples_with_eos(self, tmp_path):
        ...
        from tokenizers.trainers import BpeTrainer
        from tokenizers.pre_tokenizers import Whitespace
        from src.training.train_long import generate_samples
...
class TestMainFunctionPaths:
    ...
    def test_generate_only_no_checkpoint(self, tmp_path, monkeypatch, capsys):
        ...
        import sys
        from src.training.train_long import main
    ...
    def test_resume_no_checkpoint(self, tmp_path, monkeypatch, capsys):
        ...
        try:
            ...
            with patch('src.training.train_long.Trainer') as mock_trainer_class:
