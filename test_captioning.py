...
class TestSyntheticDataGeneration:
    ...
    def test_generate_image(self):
        ...
        from prep_caption_synthetic import generate_image, COLOR_RGB
    ...
    def test_generate_caption(self):
        ...
        from prep_caption_synthetic import generate_caption
...
class TestCaptionTraining:
    ...
    def test_caption_dataset(self, tiny_caption_data):
        """Test CaptionDataset."""
        from train_captioning import CaptionDataset
    ...
    def test_caption_trainer_init(self, tiny_caption_data):
        ...
        from train_captioning import CaptionTrainer, CaptionTrainConfig
...
class TestCaptionGeneration:
    ...
    def test_load_captioning_model(self, tiny_caption_model):
        ...
        from generate_caption import load_captioning_model
    ...
    def test_generate_caption_function(self, tiny_caption_model):
        ...
        from generate_caption import load_captioning_model, generate_caption
...
class TestCaptionIntegration:
    ...
    def test_end_to_end_synthetic(self, tmp_path):
        ...
        from prep_caption_synthetic import generate_image, generate_caption as gen_cap_text
        import random
        from train_captioning import CaptionTrainer, CaptionTrainConfig
...
class TestExtractImageFeatures:
    ...
    def test_extract_image_features_rgb(self, tmp_path):
        ...
        from generate_caption import extract_image_features
...
class TestSyntheticDataEdgeCases:
    ...
    def test_all_colors(self):
        ...
        from prep_caption_synthetic import COLOR_RGB, COLORS
    ...
    def test_all_shapes(self):
        ...
        from prep_caption_synthetic import generate_image, SHAPES, COLORS, SIZES
    ...
    def test_all_sizes(self):
        ...
        from prep_caption_synthetic import generate_image
        import numpy as np
    ...
    def test_caption_contains_all_attributes(self):
        ...
        from prep_caption_synthetic import generate_caption, COLORS, SHAPES, SIZES
...
class TestGenerateCaptionMain:
    ...
    def test_main_with_image(self, caption_checkpoint, tmp_path, monkeypatch, capsys):
        ...
        with patch('generate_caption.CLIPVisionModel') as mock_clip:
            with patch('generate_caption.CLIPImageProcessor') as mock_clip_proc:
...
class TestPrepSyntheticMain:
    ...
    def test_main_generates_data(self, tmp_path, monkeypatch):
        ...
        with patch('prep_caption_synthetic.CLIPVisionModel') as mock_clip_model:
            with patch('prep_caption_synthetic.CLIPImageProcessor') as mock_clip_processor:
                ...
                from prep_caption_synthetic import main
                main()
