...
class TestOvernightTraining:
    ...
    def test_main_builds_correct_command(self, capsys):
        ...
        from train_conditional_overnight import main

        with patch('train_conditional_overnight.subprocess.run') as mock_run:
            main()
    ...
    def test_main_prints_info(self, capsys):
        ...
        with patch('train_conditional_overnight.subprocess.run'):
            main()
