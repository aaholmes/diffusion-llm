...
import jetson_webcam_demo as demo
...
class TestModelLoading:
    ...
    def test_load_pytorch_model(self, tmp_path):
        ...
        from model import ModelConfig, DiffusionTransformer
...
class TestMainFunction:
    ...
    @patch('jetson_webcam_demo.cv2')
    @patch('jetson_webcam_demo.CLIPVisionModel')
    @patch('jetson_webcam_demo.CLIPImageProcessor')
    @patch('jetson_webcam_demo.Tokenizer')
    @patch('jetson_webcam_demo.load_pytorch_model')
    ...
    @patch('jetson_webcam_demo.CLIPImageProcessor')
    @patch('jetson_webcam_demo.Tokenizer')
    @patch('jetson_webcam_demo.load_onnx_model')
    ...
    @patch('jetson_webcam_demo.CaptionGenerator')
    @patch('jetson_webcam_demo.cv2')
    @patch('jetson_webcam_demo.CLIPVisionModel')
    @patch('jetson_webcam_demo.CLIPImageProcessor')
    @patch('jetson_webcam_demo.Tokenizer')
    ...
    def test_main_spacebar_capture(self, mock_load, mock_tokenizer_cls,
        ...
        with patch('sys.argv', ['prog', '--checkpoint', 'test.pt',
            ...
            with patch('jetson_webcam_demo.time') as mock_time_module:
