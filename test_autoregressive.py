...
from model_autoregressive import (
    AutoregressiveConfig,
    AutoregressiveCaptioner,
    SinusoidalPositionEmbeddings,
    TransformerDecoderBlock,
)
from train_autoregressive import AutoregressiveTrainer, TrainConfig, CaptionDataset
...
class TestEvalAutoregressive:
    ...
    def test_load_model(self, mock_checkpoint):
        ...
        from eval_autoregressive import load_model
    ...
    def test_main_function(self, mock_checkpoint, tmp_path, monkeypatch):
        ...
        from eval_autoregressive import main
