...
class TestCreateHighLevelDiagram:
    ...
    def test_creates_png_file(self, tmp_path):
        ...
        from visualize_architecture import create_high_level_diagram
...
class TestCreateTransformerBlockDiagram:
    ...
    def test_creates_files(self, tmp_path):
        ...
        from visualize_architecture import create_transformer_block_diagram
...
class TestCreateDiffusionProcessDiagram:
    ...
    def test_creates_files(self, tmp_path):
        """Test that diagram files are created."""
        from visualize_architecture import create_diffusion_process_diagram
...
class TestCreateTorchviewDiagram:
    ...
    def test_creates_diagram_with_torchview(self, tmp_path):
        ...
        from visualize_architecture import create_torchview_diagram
...
class TestPrintModelSummary:
    ...
    def test_prints_summary(self, capsys):
        ...
        from visualize_architecture import print_model_summary
